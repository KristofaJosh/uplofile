...
const ExampleSortableGallery = () => {
  return (
    <ExamplePage
      ...
      code={code}
      keyPoints={[
        <>Integrated with <code className="code-inline">@dnd-kit</code> for smooth drag-and-drop</>,
        <>Only completed items (<code className="code-inline">status === 'done'</code>) are draggable</>,
        <>Drag handle appears on hover in the top-left corner</>,
        <>Reordering is preserved through the <code className="code-inline">setItems</code> callback</>,
      ]}
    >
      <Demo />
    </ExamplePage>
