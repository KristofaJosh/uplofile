...
import importedCode from '@/components/ui/uplofile?raw';
...
2. Create a file `uplofile.ts` in your `src/components` directory

3. Copy and paste the following code:
    <Code title={'uplofile.ts'} lang="tsx" code={importedCode} />
