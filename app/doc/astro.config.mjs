      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Max Count and Accept",
              slug: "examples/max-count-and-accept",
            },
            {
              label: "Product Moderation",
              slug: "examples/product-moderation",
            },
            {
              label: "Spinner Avatar Upload",
              slug: "examples/spinner-avatar-upload",
            },
          ],
        },
      ],
