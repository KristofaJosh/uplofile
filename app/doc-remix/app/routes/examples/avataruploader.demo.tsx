...
import { IoPersonOutline, IoCameraOutline, IoReloadOutline, IoAlertCircleOutline, IoRefreshOutline } from "react-icons/io5";
        ...
        <UplofileTrigger>
          ...
          >
            {item?.previewUrl ? (
              ...
              <IoPersonOutline className="w-16 h-16 text-muted-foreground/50" />
            )}
            ...
            <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              <IoCameraOutline className="w-8 h-8 text-white mb-1" />
            ...
            {item?.status === "uploading" && (
              <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center backdrop-blur-[2px]">
                <IoReloadOutline className="w-8 h-8 text-white animate-spin mb-2" />
            ...
            {item?.status === "error" && (
              <div className="absolute inset-0 bg-destructive/60 flex flex-col items-center justify-center backdrop-blur-[1px]">
                <IoAlertCircleOutline className="w-8 h-8 text-white mb-1" />
